            ...
            try {
                ...
                await setDoc(doc(FIREBASE_DB, "users", user.uid), {
                    ...
                    ownedbodyfourBit: [
                      ...
                      bodyData[0].fourBitUrl,
                      bodyData[1].fourBitUrl,
                      bodyData[2].fourBitUrl,
                      bodyData[3].fourBitUrl,
                      bodyData[4].fourBitUrl,
                    ],
                    ownedbodyeightBit: [
                      bodyData[0].eightBitUrl,
                      bodyData[1].eightBitUrl,
                      bodyData[2].eightBitUrl,
                      bodyData[3].eightBitUrl,
                      bodyData[4].eightBitUrl,
                    ],
                    ownedbodysixteenBit: [
                      bodyData[0].sixteenBitUrl,
                      bodyData[1].sixteenBitUrl,
                      bodyData[2].sixteenBitUrl,
                      bodyData[3].sixteenBitUrl,
                      bodyData[4].sixteenBitUrl,
                    ],
                    ownedshirtfourBit: ["null"],
                    ownedshirteightBit: ["null"],
                    ownedshirtsixteenBit: ["null"],
                    ownedpantsfourBit: ["null"],
                    ownedpantseightBit: ["null"],
                    ownedpantssixteenBit: ["null"],
                    ownedhatfourBit: ["null"],
                    ownedhateightBit: ["null"],
                    ownedhatsixteenBit: ["null"],
                    ownedshoesfourBit: ["null"],
                    ownedshoeseightBit: ["null"],
                    ownedshoessixteenBit: ["null"],
                    ownedaccfourBit: ["null"],
                    ownedacceightBit: ["null"],
                    ownedaccsixteenBit: ["null"],
                    equipped: {
                        body: bodyData[3].fourBitUrl,
                        shirt: "null",
                        pants: "null",
                        hat: "null",
                        shoes: "null",
